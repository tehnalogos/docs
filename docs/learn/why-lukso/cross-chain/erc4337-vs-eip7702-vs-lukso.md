...
| Infrastructure required | Bundler + EntryPoint + paymaster + indexer               | Paymaster + bundler (for full gasless UX)                 | LSP25 relayer — a single submit-call service                                                                     |
...
| Recovery                | Per-SDK; passkeys in Smart Wallet, modules in Safe       | Inherits delegated implementation                         | Multi-controller / social recovery via LSP6 + [LSP14](../../../standards/access-control/lsp14-ownable-2-step.md) |
